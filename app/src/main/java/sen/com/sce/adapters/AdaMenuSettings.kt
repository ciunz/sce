 ...
 * SCE
 */
class AdaMenuSettings(private val items: ArrayList<MenuSetting>) : RecyclerView.Adapter<AdaMenuSettings.VH>() {
    var onItemClick: ((item: MenuSetting, pos: Int) -> Unit)? = null
